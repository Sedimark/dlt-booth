...
pub mod erc721_base {
    const _: () = {
        ::core::include_bytes!(
            "C:\\Users\\LucaGiorgino\\Documents\\GitHub\\mediterraneus-smart-contracts\\artifacts\\contracts\\ERC721Base.sol\\ERC721Base.json",
        );
    };
    #[allow(deprecated)]
    ...
    impl<M: ::ethers::providers::Middleware> ERC721Base<M> {
        ...
        > {
            let factory = ::ethers::contract::ContractFactory::new(
                ERC721BASE_ABI.clone(),
                ERC721BASE_BYTECODE.clone().into(),
                client,
            );
    ...
    impl ::ethers::contract::EthLogDecode for ERC721BaseEvents {
        fn decode_log(
            log: &::ethers::core::abi::RawLog,
        ) -> ::core::result::Result<Self, ::ethers::core::abi::Error> {
            if let Ok(decoded) = ApprovalFilter::decode_log(log) {
                return Ok(ERC721BaseEvents::ApprovalFilter(decoded));
            }
            if let Ok(decoded) = ApprovalForAllFilter::decode_log(log) {
                return Ok(ERC721BaseEvents::ApprovalForAllFilter(decoded));
            }
            if let Ok(decoded) = BatchMetadataUpdateFilter::decode_log(log) {
                return Ok(ERC721BaseEvents::BatchMetadataUpdateFilter(decoded));
            }
            if let Ok(decoded) = InitializedFilter::decode_log(log) {
                return Ok(ERC721BaseEvents::InitializedFilter(decoded));
            }
            if let Ok(decoded) = MetadataUpdateFilter::decode_log(log) {
                return Ok(ERC721BaseEvents::MetadataUpdateFilter(decoded));
            }
            if let Ok(decoded) = NftmintedFilter::decode_log(log) {
                return Ok(ERC721BaseEvents::NftmintedFilter(decoded));
            }
            if let Ok(decoded) = TokenCreatedFilter::decode_log(log) {
                return Ok(ERC721BaseEvents::TokenCreatedFilter(decoded));
            }
            if let Ok(decoded) = TransferFilter::decode_log(log) {
                return Ok(ERC721BaseEvents::TransferFilter(decoded));
            }
            Err(::ethers::core::abi::Error::InvalidData)
        }
    }
    impl ::core::fmt::Display for ERC721BaseEvents {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<ApprovalFilter> for ERC721BaseEvents {
        fn from(value: ApprovalFilter) -> Self {
            Self::ApprovalFilter(value)
        }
    }
    impl ::core::convert::From<ApprovalForAllFilter> for ERC721BaseEvents {
        fn from(value: ApprovalForAllFilter) -> Self {
            Self::ApprovalForAllFilter(value)
        }
    }
    impl ::core::convert::From<BatchMetadataUpdateFilter> for ERC721BaseEvents {
        fn from(value: BatchMetadataUpdateFilter) -> Self {
            Self::BatchMetadataUpdateFilter(value)
        }
    }
    impl ::core::convert::From<InitializedFilter> for ERC721BaseEvents {
        fn from(value: InitializedFilter) -> Self {
            Self::InitializedFilter(value)
        }
    }
    impl ::core::convert::From<MetadataUpdateFilter> for ERC721BaseEvents {
        fn from(value: MetadataUpdateFilter) -> Self {
            Self::MetadataUpdateFilter(value)
        }
    }
    impl ::core::convert::From<NftmintedFilter> for ERC721BaseEvents {
        fn from(value: NftmintedFilter) -> Self {
            Self::NftmintedFilter(value)
        }
    }
    impl ::core::convert::From<TokenCreatedFilter> for ERC721BaseEvents {
        fn from(value: TokenCreatedFilter) -> Self {
            Self::TokenCreatedFilter(value)
        }
    }
    impl ::core::convert::From<TransferFilter> for ERC721BaseEvents {
    ...
    impl ::ethers::core::abi::AbiDecode for ERC721BaseCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::ethers::core::abi::AbiEncode for ERC721BaseCalls {
    ...
    impl ::core::fmt::Display for ERC721BaseCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AddNewErc20TokenCall> for ERC721BaseCalls {
        fn from(value: AddNewErc20TokenCall) -> Self {
            Self::AddNewErc20Token(value)
        }
    }
    impl ::core::convert::From<ApproveCall> for ERC721BaseCalls {
        fn from(value: ApproveCall) -> Self {
            Self::Approve(value)
        }
    }
    impl ::core::convert::From<BalanceOfCall> for ERC721BaseCalls {
        fn from(value: BalanceOfCall) -> Self {
            Self::BalanceOf(value)
        }
    }
    impl ::core::convert::From<BurnCall> for ERC721BaseCalls {
        fn from(value: BurnCall) -> Self {
            Self::Burn(value)
        }
    }
    impl ::core::convert::From<CreateDataTokenCall> for ERC721BaseCalls {
        fn from(value: CreateDataTokenCall) -> Self {
            Self::CreateDataToken(value)
        }
    }
    impl ::core::convert::From<GetApprovedCall> for ERC721BaseCalls {
        fn from(value: GetApprovedCall) -> Self {
            Self::GetApproved(value)
        }
    }
    impl ::core::convert::From<GetAssetDownloadURLCall> for ERC721BaseCalls {
        fn from(value: GetAssetDownloadURLCall) -> Self {
            Self::GetAssetDownloadURL(value)
        }
    }
    impl ::core::convert::From<GetDTaddressesCall> for ERC721BaseCalls {
        fn from(value: GetDTaddressesCall) -> Self {
            Self::GetDTaddresses(value)
        }
    }
    impl ::core::convert::From<GetNFTownerCall> for ERC721BaseCalls {
        fn from(value: GetNFTownerCall) -> Self {
            Self::GetNFTowner(value)
        }
    }
    impl ::core::convert::From<InitializeCall> for ERC721BaseCalls {
        fn from(value: InitializeCall) -> Self {
            Self::Initialize(value)
        }
    }
    impl ::core::convert::From<IsApprovedForAllCall> for ERC721BaseCalls {
        fn from(value: IsApprovedForAllCall) -> Self {
            Self::IsApprovedForAll(value)
        }
    }
    impl ::core::convert::From<NameCall> for ERC721BaseCalls {
        fn from(value: NameCall) -> Self {
            Self::Name(value)
        }
    }
    impl ::core::convert::From<OwnerOfCall> for ERC721BaseCalls {
        fn from(value: OwnerOfCall) -> Self {
            Self::OwnerOf(value)
        }
    }
    impl ::core::convert::From<SafeTransferFromCall> for ERC721BaseCalls {
    ...
    impl ::core::convert::From<SetApprovalForAllCall> for ERC721BaseCalls {
        fn from(value: SetApprovalForAllCall) -> Self {
            Self::SetApprovalForAll(value)
        }
    }
    impl ::core::convert::From<SupportsInterfaceCall> for ERC721BaseCalls {
        fn from(value: SupportsInterfaceCall) -> Self {
            Self::SupportsInterface(value)
        }
    }
    impl ::core::convert::From<SymbolCall> for ERC721BaseCalls {
        fn from(value: SymbolCall) -> Self {
            Self::Symbol(value)
        }
    }
    impl ::core::convert::From<TokenURICall> for ERC721BaseCalls {
        fn from(value: TokenURICall) -> Self {
            Self::TokenURI(value)
        }
    }
    impl ::core::convert::From<TransferFromCall> for ERC721BaseCalls {
        fn from(value: TransferFromCall) -> Self {
            Self::TransferFrom(value)
        }
    }
    impl ::core::convert::From<VerifyPoPCall> for ERC721BaseCalls {
